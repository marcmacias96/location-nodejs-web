...
router.get('/mapa/new-ubication', (req,res) => {
...
router.get('/mapa/edit-ubication/:id', async (req,res) => {
    const ubication =await Ubication.findById(req.params.id)
    res.render('map/edit-ubication', {ubication})
})
router.put('/mapa/edit-ubication/:id', async (req,res) => {
